...
import { Params } from "../cosmoscheckers/params";
import { NextGame } from "../cosmoscheckers/next_game";
import { StoredGame } from "../cosmoscheckers/stored_game";
import {
  PageRequest,
  PageResponse,
} from "../cosmos/base/query/v1beta1/pagination";

export const protobufPackage = "oxkai27.cosmoscheckers.cosmoscheckers";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "oxkai27.cosmoscheckers.cosmoscheckers.Query",
      "Params",
      data
    );
