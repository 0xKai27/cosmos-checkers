...
export interface CosmoscheckersQueryAllStoredGameResponse {
 ...
 */
export interface CosmoscheckersQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: CosmoscheckersParams;
}
...
/**
 * @title cosmoscheckers/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/OxKai27/cosmos-checkers/cosmoscheckers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CosmoscheckersQueryParamsResponse, RpcStatus>({
      path: `/OxKai27/cosmos-checkers/cosmoscheckers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/OxKai27/cosmos-checkers/cosmoscheckers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CosmoscheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/OxKai27/cosmos-checkers/cosmoscheckers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/OxKai27/cosmos-checkers/cosmoscheckers/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CosmoscheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/OxKai27/cosmos-checkers/cosmoscheckers/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
